...
class TestFilter:
    ...
    def test_ignore_words(self) -> None:
        ...
        assert filter_instance.is_profane("This is a hell test")  # Should still detect other words
    ...
    def test_case_sensitivity(self) -> None:
        ...
        # Case sensitive
        case_sensitive_filter = Filter({"case_sensitive": True})
        # Note: This depends on the actual words in the dictionary
        # Adjust based on your dictionary content
    ...
    def test_word_boundaries(self) -> None:
        ...
        assert not filter_instance.is_profane("className")  # Assuming 'ass' is in dictionary
        
        # Without word boundaries
        no_boundaries_filter = Filter({"word_boundaries": False})
    ...
    def test_matches_method(self) -> None:
        ...
        test_word = "damn"
        assert filter_instance.matches(test_word) == filter_instance.is_profane(test_word)
